"use client";
import LoginButton from "@/components/core/login-button";
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <Link className="bg-green-300 font-semibold text-sm rounded-md px-3 py-2 text-gray-800 hover:bg-green-200 inline-flex items-center" 
                href="/billboard/create">
                    Register Billboard
                  </Link>

                {/* Profile dropdown */}
                <div className="relative ml-3 text-gray-300">
                    <LoginButton />
                </div>
              </div>
